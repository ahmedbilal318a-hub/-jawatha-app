-- ============================================
-- Jawatha — تحديث قائمة معلمي القسم الأدبي
-- شغّل ده مرة واحدة في Supabase SQL Editor
-- ============================================
-- ملاحظة: حقل subject موجود في الجدول لكن لن يُعرض للطالب،
-- فقط يُستخدم داخلياً لتصنيف المعلمين.
-- ============================================

create extension if not exists pgcrypto;

-- تحديث اسم بلال للاسم الكامل (مع الاحتفاظ بنفس اليوزر والباسورد)
update public.teachers
set name = 'بلال سالم سادات عبدالمقصود',
    subject = 'القسم الأدبي'
where username = 'belal';

-- تحديث اسم هشام للاسم الكامل
update public.teachers
set name = 'هشام إبراهيم أحمد قاسم',
    subject = 'القسم الأدبي'
where username = 'hisham';

-- ============================================
-- إضافة المعلمين الجدد (20 معلم)
-- ON CONFLICT لتجنب الخطأ لو تم تشغيل الـSQL مرة تانية
-- ============================================
